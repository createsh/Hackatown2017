...
public class MainActivity extends Activity implements View.OnClickListener {
  ...
  //  Button btnMove;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        random1 = inflateRowView("", "", mainContent);
        random2 = inflateRowView("", "", mainContent);
        //random3 = inflateRowView("", "", mainContent);
        nluButton = playBox("", mainContent);
        nluButton = playBox("PLAY", mainContent);
        ...
        //nluButton = playBox("PLAY", coreTech);
    ...
    private View inflateRowView(String mainText, String subText, LinearLayout parent) {
        View v = (View) getLayoutInflater().inflate(R.layout.activity_main_row2, null);
    ...
    private View playBox(String mainText, LinearLayout parent) {
